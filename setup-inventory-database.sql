-- ============================================================================
-- COMPLETE INVENTORY SYSTEM DATABASE SETUP
...
-- ============================================================================
-- PART 1: ANODE CATALOG TABLES (if not already created)
-- ============================================================================
...
-- Anode-specific inventory tracking
...
-- ============================================================================
-- PART 2: GENERAL INVENTORY SYSTEM
-- ============================================================================
...
-- ============================================================================
-- PART 3: FUTURE BOAT MANAGEMENT (structure ready for later use)
-- ============================================================================
...
-- ============================================================================
-- PART 9: ROW LEVEL SECURITY (Optional - Uncomment if needed)
-- ============================================================================

-- ALTER TABLE anodes_catalog ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE anode_inventory ENABLE ROW LEVEL SECURITY;
...
SELECT
    tablename,
    CASE
        WHEN tablename IN ('anodes_catalog', 'anode_inventory') THEN 'Anode System'
        WHEN tablename IN ('inventory_items', 'item_categories', 'inventory_suppliers', 'inventory_transactions') THEN 'Inventory System'
        WHEN tablename IN ('purchase_orders', 'purchase_order_items', 'replenishment_list') THEN 'Ordering System'
        WHEN tablename IN ('boats', 'boat_anode_types', 'anode_tool_requirements') THEN 'Boat Management'
        ELSE 'Other'
    END as system_category
FROM pg_tables
WHERE schemaname = 'public'
    AND tablename IN (
        'anodes_catalog', 'anode_inventory', 'inventory_items', 'item_categories',
        'inventory_suppliers', 'inventory_transactions', 'purchase_orders',
        'purchase_order_items', 'replenishment_list', 'boats', 'boat_anode_types',
        'anode_tool_requirements', 'item_suppliers'
    )
